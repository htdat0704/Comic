...
<body>
        ...
        if (isset($_POST['ok'])) 
        {
            ...
            else
            {
                ...
                $query = " SELECT * FROM truyen where ten like '%$search%' ORDER BY luotxem DESC";
                ...
                if ($num > 0 && $search != "") 
                {
                  ...
                  ?>  
                   ...
                   <h1 class="text-center">Truyện Dành Cho Bạn</h1>
				<br>
				<div class="phanba">
				<div class="container-fluid">
				<div class="row">	
      ...
      ?>
        <div class="col-12 col-sm-12 col-md-3 col-lg-3">
          <a href="pages.php?id=<?php echo $rowsp['id'] ?>"><img style="width:200px; height:180px;" class="img-fluid img-thumbnail img-responsive" src="<?php echo $dir.$anhne?>.png"/></a><br>
          <span class="gia"><?php echo $rowsp['ten']?></span><br>
          <span class="giax"><?php echo number_format($rowsp['luotxem'])?> Lượt xem</span>
          <p><a href="pages.php?id=<?php echo $rowsp['id'] ?>"><span style="background-color: #007bff !important;" class="btn btn-primary btn-lg" href="Product.php" role="button">Xem truyện</span></a></p><br>
        </div>
        <?php 
      }		 
                    ?>
...
<?php 
	...
	<h1 class="text-center" style="color:green;">Truyện Hot</h1>
	<br>
<div class="phanba">
	<div class="container-fluid">
		<div class="row">	
            ...
            if($from<0) $from=0;
            $qr = "SELECT * FROM truyen ORDER BY luotxem DESC LIMIT $from, $sotin1trang ";
      ...
      ?>
        <div class="col-12 col-sm-12 col-md-3 col-lg-3">
          ...
          <span class="gia"><?php echo $rowsp['ten']?></span><br>
          <span class="giax"><?php echo number_format($rowsp['luotxem'])?> Lượt xem</span>
          <p><a href="pages.php?id=<?php echo $rowsp['id'] ?>" class="card-link"><span style="background-color: #007bff !important;" class="btn btn-primary btn-lg" href="Product.php" role="button">Xem truyện</span></a></p><br>
        </div>
        <?php 
      }
				?>
