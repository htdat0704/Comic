 <nav class="navbar navbar-expand-md navbar-light bg-light ">
  <div class="container-fluid">
    <a class="navbar-branch" href="">
      <img src="images/DDaHs.png" alt="Drink   Finder" title="DDaH "width="100" height="80">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown">
         ...
         <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    			<a class="dropdown-item" href="../wrb/vieckhachhang/giaodienkhachhang.php">Thông tin</a>
    			<a class="dropdown-item" href="../wrb/vieckhachhang/khsuakh.php">Sửa thông tin</a>
   				<a class="dropdown-item" href="../homepage/dangxuat.php">Đăng xuất</a>
  		</div>
  	</div>
      </ul>
    </div>
