...
<body>
        ...
        if (isset($_POST['ok'])) 
        {
            ...
            else
            {
                ...
                $query = " SELECT * FROM truyen where ten like '%$search%' ORDER BY id DESC";
...
<?php 
	...
	<h1 class="text-center" style="color:red;">Truyện Mới</h1>
	<br>
<div class="phanba">
	<div class="container-fluid">
		<div class="row">	
            ...
            if($from<0) $from=0;
            $qr = "SELECT * FROM truyen ORDER BY id DESC LIMIT $from, $sotin1trang ";
