 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            ...
            <div class="text-center"><a href="../qlanh.php?id=<?php echo $_SESSION['idchap']?>" class="templatemo-edit-btn">Danh sách</a>
              <a href="#" class="templatemo-edit-btn">Thêm Ảnh</a>
            <br>
            <br>
            ...
            <div class="col-sm-6">
            <input  type="file" class="form-control" name="filename" value=""><br><input  name="submit" type="submit" value="Đăng ảnh">    <a href="../qlanh.php" class="templatemo-edit-btn">Bỏ qua</a>  
            </div>
            </div>
            </form>
...
<?php
	...
	$so = 0;
	$sql = "SELECT * from anh ";
	if(empty($lol = mysqli_query($con,$sql)))
	{
		1;
	}
	else
	{
		while ($rowww=mysqli_fetch_array($lol)) {
			if($so<$rowww['id'])
			{
			$so = $rowww['id'] ;
		}
    ...
    $truyenlink = "http://192.168.1.5/appandroid/wrb/anh/".$_SESSION['idtruyen']."/".$_SESSION['idchap']."/";
    $link = $truyenlink.$name."."."png";
    if(file_exists($dir.$so."."."png")){
    $sqladd="INSERT INTO anh(anh, idchap) VALUES ('$link','".$_SESSION['idchap']."')"; 
