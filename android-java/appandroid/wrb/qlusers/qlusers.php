      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="#"><i class="fa fa-users fa-fw"></i>Quản Lí khách hàng</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            ...
            <br>
            <br>
              <div class="text-center"><h1>Danh sách thành viên </h1></div>
              <br>
                      ...
                      $name= $row["id"];
                        While(!file_exists($dir.$name."."."png"))
                       {
                          ...
                          echo"<tr>";
                           ...
                           echo'<td class="text-center"><a href="suausers/suausers.php?id='.$row['id'].'" class="templatemo-edit-btn" style="color:blue">Sửa</a></td>';
                           echo'<td class="text-center"><a href="deleteusers.php?id='.$row['id'].'" class="templatemo-edit-btn" style="color:red" onclick= "alert('.$xoa.');">Xóa</a></td>';
                            echo"</tr>";
                      }
