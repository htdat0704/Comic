...
<body>
 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <br>
            <div class="text-center"><a href="../qltruyen.php" class="templatemo-edit-btn">Danh sách</a>
              <a href="#" class="templatemo-edit-btn">Thêm Truyện</a>
            <br>
            <br>
              <div class="text-center"><h1>Thêm Truyện</h1></div>
            <br>
            <div class="container">
        <form class="form-horizontal" action="xulyvathemanhtruyen.php" method="get">
        ...
        <div class="col-sm-7">
        <input type="type" class="form-control" name="noidung">      
        </div>
        </div>
        <br>
            <div class="form-group">        
