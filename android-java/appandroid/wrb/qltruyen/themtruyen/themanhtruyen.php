...
<body>
 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            ...
            <div class="col-sm-7">
            <input  type="file" class="form-control" name="filename" value=""><br><input  name="submit" type="submit" value="Đăng ảnh">    <a href="../qltruyen.php" class="templatemo-edit-btn">Bỏ qua</a>  
            </div>
            </div>
            </form>
        </div>
<?php
	...
	$dir='../../anh/'.$_SESSION['id'].'/';
  if(!file_exists('../../anh/'.$_SESSION['id'].''))
  {
  mkdir('../../anh/'.$_SESSION['id'].'');
  }
	if (isset($_POST['submit'])){	
		...
		if(($duoi=='jpg')||($duoi=='png')||($duoi=='jpeg')||($duoi=='gif'))
		{
			...
			echo '<br><div class="text-center"><a href="../qltruyen.php" class="templatemo-edit-btn">Hoàn thành</a></div><br>';
		}
		else{
			echo '<div class="text-center" style="color:red " >file không chấp nhận chỉ chấp nhận đuôi file |jpg|png|jpeg|gif| </div>';
		}
    $truyenlink = "http://192.168.1.5/appandroid/wrb/anh/$name/";
    $link = $truyenlink.$name."."."png";
    $sqladd="UPDATE truyen SET anh = '$link' where id=$name ";
