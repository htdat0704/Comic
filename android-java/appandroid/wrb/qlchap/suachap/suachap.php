...
<body>
 ...
 <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <br>
              <div class="text-center"><h1>Sửa thông tin chap</h1></div>
            <br>
          	<?php 
          	$qlkhs="select * from chap where id=".$_SESSION['id']; 
          	$roa= mysqli_query($con,$qlkhs);
          	$row= mysqli_fetch_array($roa);
            $_SESSION['num']=$row['tentruyen'];
            $cat = substr($row['tentruyen'], 5);
          	?>
          	<div class="container">
        	<form class="form-horizontal" action="xulysuachap.php" method="get">
        	<div class="form-group">
       		<label class="control-label col-sm-2" >Số Chap:</label>
        	<div class="col-sm-7">
        	<input  type="number" step="0.1" class="form-control" name="sp" placeholder="<?php echo $cat; ?>"><input onclick= "alert('Sửa thành công');" type="submit" value="Thay đổi">      
        	</div>
        	</div>
        	</form>
    	</div>
